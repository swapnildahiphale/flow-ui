...
func setupFixture(t *testing.T) (*Handler, *http.ServeMux) {
	...
	h := &Handler{DB: conn, Files: &files.Reader{Root: t.TempDir()}, Archive: func(string) error { return errString("archive not stubbed") }, Do: func(string) error { return errString("do not stubbed") }}
